...
// Color Inspector wrappers — Color Wheels expose numeric inputs in the Color
// Inspector for Master / Shadows / Midtones / Highlights × Saturation /
// Brightness. The wheel-drag UI affordance maps onto these numeric AXValue
// inputs, so setting them yields the same colour change as dragging.
Object.assign(INSPECTOR, {
  // Master wheel
  "set-master-sat":  setVal("Master Saturation"),
  "set-master-bri":  setVal("Master Brightness"),
  // Shadows wheel
  "set-shadows-sat": setVal("Shadows Saturation"),
  "set-shadows-bri": setVal("Shadows Brightness"),
  // Midtones wheel
  "set-mids-sat":    setVal("Midtones Saturation"),
  "set-mids-bri":    setVal("Midtones Brightness"),
  // Highlights wheel
  "set-highs-sat":   setVal("Highlights Saturation"),
  "set-highs-bri":   setVal("Highlights Brightness"),
  // Color Board sliders (alternative to Color Wheels)
  "set-saturation":  setVal("Saturation"),
  "set-exposure":    setVal("Exposure"),
  "set-contrast":    setVal("Contrast"),
  "set-highlights":  setVal("Highlights"),
  "set-shadows":     setVal("Shadows"),
  "set-midtones":    setVal("Midtones"),
  // Audio Inspector pan + EQ
  "set-pan":         setVal("Pan Amount"),
  "set-pan-mode":    setVal("Pan Mode"),
  // Compositing
  "set-blend-mode":  setVal("Blend Mode"),
  // Crop / distort numeric inputs
  "set-crop-left":   setVal("Crop Left"),
  "set-crop-right":  setVal("Crop Right"),
  "set-crop-top":    setVal("Crop Top"),
  "set-crop-bottom": setVal("Crop Bottom"),
});
...
export const INSPECTOR_HELP = [
  ...
  ["Color wheels",        ["set-master-sat <v>", "set-master-bri <v>", "set-shadows-sat <v>", "set-shadows-bri <v>", "set-mids-sat <v>", "set-mids-bri <v>", "set-highs-sat <v>", "set-highs-bri <v>"]],
  ["Color board",         ["set-saturation <v>", "set-exposure <v>", "set-contrast <v>", "set-highlights <v>", "set-shadows <v>", "set-midtones <v>"]],
  ["Audio / compositing", ["set-pan <v>", "set-pan-mode <v>", "set-blend-mode <v>"]],
  ["Crop / distort",      ["set-crop-left <v>", "set-crop-right <v>", "set-crop-top <v>", "set-crop-bottom <v>"]],
