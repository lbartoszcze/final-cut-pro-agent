...
export function overlayTitles(srcPath, titles, totalSec, outPath) {
  ...
  const styleFor = (pos) => pos === "lower-third"
    ? { sz: 64, x: "80", y: "h-260", box: "1", bc: "black@0.6", bw: "16" }
    : pos === "end-card"
    ? { sz: 130, x: "(w-text_w)/2", y: "(h-text_h)/2", box: "0", bc: "black@0", bw: "0" }
    : { sz: 96, x: "(w-text_w)/2", y: "(h-text_h)/2", box: "1", bc: "black@0.4", bw: "20" };
